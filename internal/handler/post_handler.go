...
func (h *Handler) createPost(w http.ResponseWriter, r *http.Request) {
	...
	switch r.Method {
	case http.MethodGet:
		if err := h.tmlExecute(w, "./ui/create_post.html", user); err != nil {
			return
		}
	case http.MethodPost:
		...
		if err != nil {
			log.Println(err)
			h.ErrorHandle(w, http.StatusInternalServerError, "can not creat post")
		}
...
func (h *Handler) myPosts(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.ErrorHandle(w, http.StatusInternalServerError, http.StatusText(http.StatusInternalServerError))
		return
	}
...
func (h *Handler) myFavourites(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tmlExecute(w, "./ui/index.html", pageData); err != nil {
		fmt.Println("my favourites: tmlExecute()")
		return
	}
}
...
func (h *Handler) post(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil || *post == emptyPost {
		h.ErrorHandle(w, http.StatusNotFound, "Sorry, but no pages were found for your request =(")
		return
	}
	...
	if err := h.tmlExecute(w, "./ui/post.html", postData); err != nil {
