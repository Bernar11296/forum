...
func (r *LikeRepo) SetPostLike(like models.Like) error {
	...
	if err != nil {
		return fmt.Errorf("set post like: %w", err)
	}
	return nil
}
...
func (r *LikeRepo) SetCommentLike(like models.Like) error {
	...
	if err != nil {
		log.Printf("set comment like: %s", err)
		return fmt.Errorf("set post like: %w", err)
	}
	return nil
}
...
func (r *LikeRepo) DeleteCommentLike(userID, commentID int) error {
	...
	if err != nil {
		log.Printf("delete comment like: %s", err)
		return fmt.Errorf("delete post like: %w", err)
	}
	return nil
}
...
func (r *LikeRepo) DeleteCommentDislike(userID, commentID int) error {
	...
	_, err := r.db.Exec(query, userID, commentID)
	if err != nil {
		log.Printf("delete comment dislike: %s", err)
		return fmt.Errorf("delete post dislike: %w", err)
	}
	return nil
}
